      ...
      <template v-else>
        ...
        >
          <div class="flex items-center gap-6 h-7 max-w-[calc(100%_-_280px)] xs:max-w-[calc(100%_-_90px)]">
            <div class="transition-all duration-200 cursor-pointer transform hover:scale-105">
              <img v-if="isDark" width="96" alt="Propelio" src="~/assets/img/brand/text.png" class="flex-none min-w-[96px]" />
              <img v-else width="96" alt="Propelio" src="~/assets/img/brand/nocodb.png" class="flex-none min-w-[96px]" />
            </div>
